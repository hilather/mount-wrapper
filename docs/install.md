...
```text
https://github.com/hilather/mount-wrapper/releases/download/v0.1.6/mount-wrapper_0.1.6_darwin_arm64.tar.gz
https://github.com/hilather/mount-wrapper/releases/download/v0.1.6/mount-wrapper_0.1.6_darwin_amd64.tar.gz
```

(`arm64` = Apple Silicon, `amd64` = Intel; version in the sketch tracks **0.1.6**
